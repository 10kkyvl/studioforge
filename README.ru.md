...
- **Часть возможностей ещё сырая или неполная.** Память проекта намеренно минимальна: она хранит записи из промптов запусков, а не сводки решений агента. Полный список: [docs/KNOWN_LIMITATIONS.md](docs/KNOWN_LIMITATIONS.md) (на английском).
