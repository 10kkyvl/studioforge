...
- **Часть возможностей ещё сырая или неполная.** Память проекта хранит ограниченные выдержки из сообщённых результатов запусков, а не независимо проверенные факты. Полный список: [docs/KNOWN_LIMITATIONS.md](docs/KNOWN_LIMITATIONS.md) (на английском).
...
Публичная beta (v0.6.0). Стабильного интерфейса пока нет — ожидайте изменений между релизами. Прочитайте [Известные ограничения](docs/KNOWN_LIMITATIONS.md), прежде чем полагаться на StudioForge в реальном проекте.
